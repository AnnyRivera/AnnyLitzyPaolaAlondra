...
if (isset($_POST['recoverPassword'])) {
    ...
    if ($stmt->execute()) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'mireleslitzzy.06@gmail.com'; // Cambia a tu dirección de Gmail
            $mail->Password = 'vsnl kvmr drge ryji'; // Usa la contraseña de aplicación generada
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS; // O SSL si corresponde
            $mail->Port = 587; // O el puerto que estás utilizando/

            // Configuración adicional
            $mail->setFrom('mireleslitzzy.06@gmail.com', '4 nenis'); // Cambia según sea necesario
            ...
            <body>
              <div class="card">
                <div class="card-title"> 4 nenis </div>
                <div class="card-body">
                  <p>Hola,</p>
